  ...
  var ThemeBuilder = (function () {
    ...
    var magnificPopupImageView = function () {
      ...
      if (checkSelectorExistence('.mfp-gallery')) {
        jQuery('.mfp-gallery').magnificPopup({
          /* mfp-gallery to  magnific-image*/ delegate: '.mfp-link' /* magnific-anchor to  magnific-anchor*/,
          type: 'image',
      ...
      if (checkSelectorExistence('.video')) {
        jQuery('.video').magnificPopup({
          /* video to  magnific-video*/ type: 'iframe',
          iframe: {
            markup:
      ...
      if (checkSelectorExistence('.popup-youtube, .popup-vimeo, .popup-gmaps')) {
        /* popup-youtube to  magnific-yv (y : youtube and v : video)*/
    ...
    var pageScrollToTop = function () {
      ...
      jQuery('button.back-to-top').on('click', function () {
        /* change back-to-top to scrollToTop*/ jQuery('html').animate({ scrollTop: 0 }, 500)
        return false
      })
    ...
    var setFooterHeight = function () {
      /* change site-footer to theme-footer*/
