...
// Images
import eventPic2 from '~/assets/images/event/pic2.jpg'
import eventPic3 from '~/assets/images/event/pic3.jpg'
import eventPic4 from '~/assets/images/event/pic4.jpg'
                  ...
                  <div className="info-bx d-flex">
                    <div className="event-info">
                      <ul className="media-post">
                        <li>
                          <Link to="/events-details">
                            <i className="fa fa-clock-o"></i> 7:00am
                          </Link>
                        </li>
                        <li>
                          <Link to="/events-details">
                      ...
                      <h4 className="event-title">
                        <Link to="/events-details">{item.title}</Link>
                      </h4>
                      <p>{item.text}</p>
                    </div>
                  </div>
