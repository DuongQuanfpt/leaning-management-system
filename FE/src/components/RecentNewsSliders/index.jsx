...
// Images
import blogPic1 from '~/assets/images/blog/latest-blog/pic1.jpg'
import blogPic2 from '~/assets/images/blog/latest-blog/pic2.jpg'
import blogPic3 from '~/assets/images/blog/latest-blog/pic3.jpg'
                  ...
                  <div className="info-bx">
                    <ul className="media-post">
                      <li>
                        <Link to="/blog-details">
                          <i className="fa fa-calendar"></i>Jan 02 2019
                        </Link>
                      </li>
                      <li>
                        <Link to="/blog-details">
                          <i className="fa fa-user"></i>By William
                        </Link>
                      </li>
                    </ul>
                    ...
                    <div className="post-extra">
                      ...
                      <Link to="/blog-details" className="comments-bx">
                        <i className="fa fa-comments-o"></i>20 Comment
                      </Link>
                    </div>
                  </div>
                </div>
