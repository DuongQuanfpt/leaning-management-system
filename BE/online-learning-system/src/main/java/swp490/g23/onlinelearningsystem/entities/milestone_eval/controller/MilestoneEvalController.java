...
public class MilestoneEvalController {
    ...
    // @PutMapping(value = "/milestone-group-copy/{milestoneId}/{criteriaId}")
    // public ResponseEntity<String> criteriaEvalClear(@PathVariable("milestoneId") Long milestoneId,
    //      @PathVariable("criteriaId") Long criteriaId) {

    //     return milestoneEvalService.milestoneEvalClear(milestoneId, criteriaId);
    // }

    // @DeleteMapping(value = "/milestone-eval-clear/{milestoneId}/{criteriaId}")
    // public ResponseEntity<String> criteriaEvalClear(@PathVariable("milestoneId") Long milestoneId,
    //      @PathVariable("criteriaId") Long criteriaId) {
